    ...
    <div class="bg-white border border-[#e7e5e4] rounded-[16px] shadow-sm overflow-hidden">
      <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse">
          ...
          <tbody>
            <template v-if="store.isLoading && store.jadwal.length === 0">
              <tr v-for="i in 5" :key="'skel-' + i" class="animate-pulse border-b border-[#e7e5e4]">
                ...
                <td class="px-2 py-3 sm:p-4"><div class="h-4 bg-[#e7e5e4] rounded w-16"></div></td>
            ...
            <template v-else>
              ...
              <tr v-if="!filteredJadwal.length">
                <td colspan="5" class="p-4 sm:p-8 text-center text-[#777169]">
                  <span>Data jadwal tidak ditemukan.</span>
                </td>
              </tr>
            </template>
          </tbody>
