    ...
    <div class="bg-white border border-[#e7e5e4] rounded-[16px] shadow-sm overflow-hidden">
      <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse">
          ...
          <tbody>
            <template v-if="store.isLoading && store.warta.length === 0">
              <tr v-for="i in 5" :key="'skel-' + i" class="animate-pulse border-b border-[#e7e5e4]">
                <td class="px-2 py-3 sm:px-6 sm:py-4">
                  <div class="h-4 bg-[#e7e5e4] rounded w-24"></div>
                </td>
                <td class="px-2 py-3 sm:px-6 sm:py-4">
                  <div class="h-4 bg-[#e7e5e4] rounded w-48"></div>
                </td>
                <td class="px-2 py-3 sm:px-6 sm:py-4">
                  <div class="h-6 bg-[#e7e5e4] rounded-full w-20"></div>
                </td>
                <td class="px-2 py-3 sm:px-6 sm:py-4">
            ...
            <template v-else>
              ...
              <tr v-if="!filteredWarta.length">
                <td colspan="4" class="p-4 sm:p-8 text-center text-[#777169]">
                  <span>Data warta tidak ditemukan.</span>
                </td>
              </tr>
            </template>
          </tbody>
