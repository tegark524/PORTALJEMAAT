  ...
  >
    ...
    >
      ...
      <h1 class="font-serif text-[32px] font-bold text-[#0c0a09] leading-tight mb-2">
        {{ store.votingConfig?.judul_pemilihan || 'Bilik Suara Digital' }}
      </h1>
      <p class="text-[15px] text-[#4e4e4e] font-sans mb-8 whitespace-pre-wrap">
        {{ store.votingConfig?.deskripsi || 'Pemilihan Majelis Jemaat GKJW Sukolilo' }}
      </p>
